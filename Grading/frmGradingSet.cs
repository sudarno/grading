    ...
    public partial class frmGradingSet : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                // Create a DataSet.
                data = new DataSet();
                string sqlQuery = "select * from sizeorder where styleid='10.29285.00.70' order by ORDERNO";
                ...
                {
                    detailsDataGridView.Columns.Add(Convert.ToString(data.Tables[0].Rows[i]["SIZEID"]), Convert.ToString(data.Tables[0].Rows[i]["SIZEID"]));
                    detailsDataGridView.Columns[Convert.ToString(data.Tables[0].Rows[i]["SIZEID"])].Width = 50;
                }
