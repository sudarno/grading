...
{
    public partial class qcreportperline : Form
    {
        BindingSource masterBindingSource = new BindingSource();
        private MySqlDataAdapter masterDataAdapter = null;
        string date1, date2;
        public qcreportperline()
        {
            InitializeComponent();
        }
        ...
        private void qcreportperline_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                qcreportperlineCR objRpt = new qcreportperlineCR();
