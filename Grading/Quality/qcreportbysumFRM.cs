...
{
    public partial class qcreportbysumFRM : Form
    {
        ...
        private void qcreportbysumFRM_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                qcreportbysumCR objRpt = new qcreportbysumCR();
