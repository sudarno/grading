...
{
    public partial class qrSewingStyleSumFRM : Form
    {
        BindingSource masterBindingSource = new BindingSource();
        private MySqlDataAdapter masterDataAdapter = null;
        string date1, date2;
        public qrSewingStyleSumFRM()
        {
            InitializeComponent();
        }
        ...
        private void qrSewingStyleSumFRM_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                qrSewingStyleSumCR objRpt = new qrSewingStyleSumCR();
