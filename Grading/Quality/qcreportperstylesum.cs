...
{
    public partial class qcreportperstylesum : Form
    {
        BindingSource masterBindingSource = new BindingSource();
        private MySqlDataAdapter masterDataAdapter = null;
        string date1, date2;
        public qcreportperstylesum()
        {
            InitializeComponent();
        }
        ...
        private void qcreportperstylesum_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                qcreportperstylesumCR objRpt = new qcreportperstylesumCR();
