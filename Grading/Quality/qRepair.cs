...
{
    public partial class qRepair : Form
    {
       ...
       // private DataTable dataTableLW = null;
        ...
        private void getData(string style)
        {
            try
            {
                ...
                // Create a DataSet.
                data = new DataSet();
                string strAdapter = "SELECT * FROM qcrepair WHERE STYLEID LIKE @STYLEID ORDER BY LINEID ASC";
                ...
                masterDataAdapter.Fill(data, "qcrepair");
                sqlCommandBuilder = new MySqlCommandBuilder(masterDataAdapter);

                masterBindingSource.DataSource = data;
                masterBindingSource.DataMember = "qcrepair";
                ...
                ColumnQtyCheck.DataPropertyName = "QTYREPAIR";
                ColumnQtyCheck.Name = "QTYREPAIR";
        ...
        private void getData(DateTime date)
        {
            try
            {
                ...
                // Create a DataSet.
                data = new DataSet();
                string strAdapter = "SELECT * FROM qcrepair WHERE DATE(DATE)=DATE('" + date.ToString("yyyy-MM-dd") + "') ORDER BY LINEID ASC";
        ...
        private void qRepair_Load(object sender, EventArgs e)
        {
        ...
        private void cmdSave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                masterDataAdapter.Update(data, "qcrepair");
