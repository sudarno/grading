...
{
    public partial class qrFinishingFrm : Form
    {
        BindingSource masterBindingSource = new BindingSource();
        private MySqlDataAdapter masterDataAdapter = null;
        string date1, date2;

        public qrFinishingFrm()
        {
            InitializeComponent();
        }
        ...
        private void qrFinishingFrm_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                //sub report
                string strQuerySub = "SELECT DATE,BUYERID,STYLEID,COLORID,LINEID,QTYREPAIR FROM qcrepair " +
                ...
                DataAdapterSub.Fill(dataSub, "qrrepairtbl");


                qrFinishingCr objRpt = new qrFinishingCr();
