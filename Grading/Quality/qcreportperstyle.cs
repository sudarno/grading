...
{
    public partial class qcreportperstyle : Form
    {
        BindingSource masterBindingSource = new BindingSource();
        private MySqlDataAdapter masterDataAdapter = null;
        string date1, date2;
        public qcreportperstyle()
        {
            InitializeComponent();
        }
        ...
        private void qcreportperstyle_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                qcreportperstyleCR objRpt = new qcreportperstyleCR();
