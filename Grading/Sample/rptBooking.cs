...
{
    public partial class rptBooking : Form
    {
        ...
        private void rptBooking_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                string strAdapter = "SELECT date(@date1) date1,date(@date2) date2, " +
                        ...
                        ",doneby,Remark " +
                        "FROM sfbooking " +
                        "INNER JOIN buyer ON buyer.BUYERID=sfbooking.buyerid " +
                ...
                rptBookingCr objRpt = new rptBookingCr();
