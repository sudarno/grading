...
{
    public partial class sfPattern : Form
    {
        ...
        private void getData(DateTime date1, DateTime date2)
        {
            try
            {
                ...
                // Create a DataSet.
                data = new DataSet();
                string strAdapter = "SELECT * FROM sfpattern WHERE isnull(datesend)  OR DATE(datercvd) BETWEEN DATE(@date1) AND DATE(@date2)";
                ...
                masterDataAdapter.Fill(data, "sfpattern");
                sqlCommandBuilder = new MySqlCommandBuilder(masterDataAdapter);

                masterBindingSource.DataSource = data;
                masterBindingSource.DataMember = "sfpattern";
        ...
        private void getDataFind()
        {
            try
            {
                ...
                // Create a DataSet.
                data = new DataSet();
                string strAdapter = "SELECT * FROM sfpattern WHERE no LIKE @DocNo AND styleid LIKE @styleid";
                masterDataAdapter = new MySqlDataAdapter(strAdapter, connection);
        ...
        private void sfPattern_Load(object sender, EventArgs e)
        {
        ...
        private void cmdSave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                masterDataAdapter.Update(data, "sfpattern");
