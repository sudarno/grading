...
{
    public partial class rptPattern : Form
    {
        ...
        private void rptPattern_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                string strAdapter = "SELECT date(@date1) date1,date(@date2) date2, " +
                        ...
                        ",doneby,Remark " +
                        "FROM sfpattern " +
                        "INNER JOIN buyer ON buyer.BUYERID=sfpattern.buyerid " +
                ...
                rptPatternCr objRpt = new rptPatternCr();
