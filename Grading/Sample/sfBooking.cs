...
{
    public partial class sfBooking : Form
    {
        ...
        private void getData(DateTime date1, DateTime date2)
        {
            try
            {
                ...
                // Create a DataSet.
                data = new DataSet();
                string strAdapter = "SELECT * FROM sfbooking WHERE isnull(datesend) OR DATE(datercvd) BETWEEN DATE(@date1) AND DATE(@date2)";
                ...
                masterDataAdapter.Fill(data, "sfbooking");
                sqlCommandBuilder = new MySqlCommandBuilder(masterDataAdapter);

                masterBindingSource.DataSource = data;
                masterBindingSource.DataMember = "sfbooking";
        ...
        private void getDataFind()
        {
            try
            {
                ...
                // Create a DataSet.
                data = new DataSet();
                string strAdapter = "SELECT * FROM sfbooking WHERE styleid LIKE @styleid AND no LIKE @DocNo";
                masterDataAdapter = new MySqlDataAdapter(strAdapter, connection);
        ...
        private void sfBooking_Load(object sender, EventArgs e)
        {
        ...
        private void cmdSave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                masterDataAdapter.Update(data, "sfbooking");
        ...
        private void cmdXSD_Click(object sender, EventArgs e)
        {
            ...
            masterDataAdapter.SelectCommand.Parameters.AddWithValue("@date2", date1.Value.ToString("yyyy-MM-dd"));
            masterDataAdapter.Fill(dsReject, "sfbookingxsd");
            Application.DoEvents();
            dsReject.WriteXmlSchema("C:\\MyGarmentReport\\sfbookingxsd.xsd");
        }
    }
}
